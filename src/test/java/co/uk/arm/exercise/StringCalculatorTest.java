...
public class StringCalculatorTest {
	...
	public void add_WithEmptyParam_Zero()
			throws NegativeNumberNotSupportedException {
	...
	@Test
	public void add_WithNumberGreaterThanMax_SumZero()
			throws NegativeNumberNotSupportedException {
	...
	@Test
	public void add_WithNumberAndNumberGreaterThanMax_SumIgnoringBigNumber()
			throws NegativeNumberNotSupportedException {
	...
	@Test
	public void add_WithNumbersAndNumberGreaterThanMax_SumIgnoringBigNumber()
			throws NegativeNumberNotSupportedException {
	...
	@Test
	public void add_WithThreeParamAndBigLengthDelimeters_Sum()
			throws NegativeNumberNotSupportedException {
		int result = calculator.add("##\n1##2");
		assertEquals(3, result);
	}
	...
	@Test
	public void add_WithThreeParamAndMultipleDelimeters_Sum()
			throws NegativeNumberNotSupportedException {
		int result = calculator.add(";##\n1##2;3");
		assertEquals(6, result);
	}
